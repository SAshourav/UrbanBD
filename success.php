...
$store_id=urlencode("urban63a8a7fe548ef");
$store_passwd=urlencode("urban63a8a7fe548ef@ssl");
...
if($code == 200 && !( curl_errno($handle)))
{
 ...
 //payment details storing
        ...
        $stmt = $conn->prepare("INSERT INTO payments (order_id,user_id,transaction_id)
          VALUES (?,?,?)");
